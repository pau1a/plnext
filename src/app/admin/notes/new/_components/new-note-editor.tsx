    ...
    <form className="u-stack u-gap-xl" action={formAction}>
      <div className="u-stack u-gap-sm">
          ...
          <div className="admin-essay-editor__lead">
            <div className="admin-essay-editor__statbar">
              <div className="admin-essay-editor__statrow">
                ...
                <span className="admin-essay-editor__stat">
                  Permalink <code>/notes/{derivedSlug || "(auto-generated)"}</code>
                </span>
              </div>
            </div>
          </div>
        ...
        <p className="u-text-muted u-text-sm">
          Fill in the details below to create a new note. The file will be saved as an MDX file in <code>content/notes</code>.
        </p>
      </div>
      ...
      <section className="u-stack u-gap-sm">
        ...
        <div className="admin-essay-editor__primary-fields">
          <label className="admin-essay-editor__field admin-essay-editor__field--inline" htmlFor="note-title">
          ...
          <label className="admin-essay-editor__field admin-essay-editor__field--inline" htmlFor="note-date">
          ...
          <label className="admin-essay-editor__field admin-essay-editor__field--summary" htmlFor="note-summary">
          ...
          <label className="admin-essay-editor__field admin-essay-editor__field--summary" htmlFor="note-tags">
            ...
            <div style={{ marginTop: "0.5rem", display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
              {AVAILABLE_TAGS.map((tag) => {
                const isSelected = tags.split(",").map((t) => t.trim()).includes(tag.slug);
                return (
                  <button
                    key={tag.slug}
                    type="button"
        ...
        <div className="admin-essay-editor__frontmatter-grid">
          <label className="admin-essay-editor__field admin-essay-editor__field--checkbox">
            ...
            <p className="admin-essay-editor__field-help u-text-muted u-text-xs">
              Draft notes stay off the public stream.
            </p>
          </label>
        </div>
      </section>
